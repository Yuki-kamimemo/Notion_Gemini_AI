...
if st.session_state["authentication_status"]:
    ...
    # --- UIコンポーネント定義 ---
    persona_options = {"プロのライター": "あなたはプロのライターです。", "マーケティング担当者": "あなたは経験豊富なマーケティング担当者です。", "技術ドキュメントライター": "あなたは正確で分かりやすい文章を書く技術ドキュメントライターです。", "カスタム": "カスタム..."}
    prompt_templates = {"記事作成": "{topic}について記事を作成してください。", "要約": "{topic}について要約してください。", "アイデア出し": "{topic}のアイデアを5つ提案してください。", "カスタム": "カスタム..."}
